...
In 2026, I completed my Ph.D. in Computer Science at Georgia Tech, advised by Prof. [John Stasko](https://www.cc.gatech.edu/home/stasko/). My research centered on how large language models can support data science, particularly visual data analysis. My broader interests span data science, data visualization, and visual analytics, especially for geographic data. During my Ph.D., I also worked with collaborators at Sanida National Labs on designing visualizations to support electric grid operators.
